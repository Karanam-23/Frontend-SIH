  ...
  return (
    <header className={`${mobileOnly ? 'lg:hidden' : ''} bg-surface flex justify-between items-center w-full px-container-padding-mobile md:px-container-padding-desktop h-16 shadow-sm bg-surface-bright border-b border-outline-variant/20 z-40 shrink-0`}>
      <div className="flex items-center gap-4 h-full">
        ...
        <button className="lg:hidden text-on-surface-variant hover:text-secondary p-2 -ml-2 rounded-full hover:bg-surface-container-low transition-colors duration-200">
      ...
      <div className="flex items-center gap-2">
        <button onClick={() => setView('assessmentHistory')} className="p-2 text-on-surface-variant hover:text-secondary rounded-full hover:bg-surface-container-low transition-colors duration-200 cursor-pointer">
          <span className="material-symbols-outlined">history</span>
        </button>
        <button className="p-2 text-on-surface-variant hover:text-secondary rounded-full hover:bg-surface-container-low transition-colors duration-200">
