...
<button onClick={() => setView('propertyForm')} className="w-full bg-secondary text-on-secondary py-3 px-4 rounded-lg font-label-sm text-label-sm hover:bg-secondary/90 transition-colors shadow-sm flex items-center justify-center space-x-2">
...
<div className="absolute top-0 left-0 w-full h-1 bg-outline-variant/50"></div>
...
<button className="bg-secondary text-on-secondary px-8 py-3.5 rounded-lg font-label-sm text-label-sm w-full sm:w-auto hover:bg-secondary-container hover:text-on-secondary-container hover:shadow-md transition-all duration-200 border border-transparent focus:ring-2 focus:ring-secondary/50 outline-none">
                Enter Address Manually
            </button>

<button className="mt-6 font-label-sm text-label-sm text-outline hover:text-on-surface transition-colors">
                Return to Dashboard
            </button>
</div>
</main>
...
<a className="flex flex-col items-center justify-center text-on-surface-variant dark:text-outline-variant hover:text-secondary transition-colors group select-none" onClick={() => setView('home')} style={{ cursor: 'pointer' }}>
